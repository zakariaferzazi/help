...
class BlackMailPostdetailsuser extends StatefulWidget {
  final item;

  const BlackMailPostdetailsuser({super.key, this.item});

  @override
  State<BlackMailPostdetailsuser> createState() => DBlackMailPostdetailsuserState();
}

class DBlackMailPostdetailsuserState extends State<BlackMailPostdetailsuser> {
