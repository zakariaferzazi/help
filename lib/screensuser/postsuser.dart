...
import '../screensadmin/login_screen/welcome page.dart';
import '../widgets/auth.dart';
import '../widgets/title_text.dart';
import 'add_requestuser.dart';
import 'home&details/details.dart';

class postsuser extends StatefulWidget {
  postsuser({Key? key, this.title}) : super(key: key);
          ...
          InkWell(
            onTap: () async {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => add_requestuser(),
                  ));
            },
            child: Container(
              decoration: BoxDecoration(
              ...
              delegate: SliverChildListDelegate(
                ...
                [
                  ...
                  InkWell(
                    onTap: () {
                                            Navigator.push(context,
                          MaterialPageRoute(builder: (context) => ChatRoomUser()));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(18),
                      child: Row(
...
class homebirsimuser extends StatefulWidget {
  homebirsimuser({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _homebirsimuserState createState() => _homebirsimuserState();
}
...
class _homebirsimuserState extends State<homebirsimuser> {
  String name = '';
